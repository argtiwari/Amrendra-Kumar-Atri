  ...
  return (
    ...
    <div className="font-sans bg-gray-50 pt-20 md:pt-24">
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-6xl mx-auto">
          ...
          >
            ...
            <ul className="space-y-4 text-gray-700 leading-relaxed text-lg list-disc pl-6">
              <li>
                मेरे पिता{" "}
                <span className="font-medium">स्वर्गीय नारायण प्रसाद जी</span>{" "}
                पूर्व मंत्री{" "}
                <span className="font-medium">श्री राजेश प्रसाद सिंह</span>{" "}
                (कांग्रेस) के निजी सचिव रहे थे।
              </li>
              <li>
                मेरी पत्नी{" "}
                <span className="font-medium">
                  नगर पंचायत, वार्ड संख्या 15, लघमा, जमुई
                </span>{" "}
      ...
      <footer className="bg-gray-900 text-gray-400 text-center py-6">
        © 2025 ArgCoding | Designed for जनसेवा
      </footer>
    </div>
  );
}
